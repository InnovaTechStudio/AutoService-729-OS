...
. Asimismo, se establecieron guías de estilo y convenciones técnicas rigurosas, redactando todo el código y documentación en inglés y aplicando arquitecturas específicas para Angular (basada en componentes) y Spring Boot (por capas), junto con el uso de Gherkin para definir criterios de aceptación que faciliten la comunicación con los interesados<br>TB1: Alineándonos con las exigencias globales del desarrollo de software moderno, todo el código fuente, la documentación técnica de los módulos y los comentarios internos se redactaron rigurosamente en idioma inglés. Finalmente, se incorporó el uso de la sintaxis Gherkin para la definición formal de los escenarios y criterios de aceptación de cada historia de usuario, cerrando eficazmente la brecha de comunicación con los interesados y sentando las bases del desarrollo guiado por comportamiento (BDD) <br>AV2: Los escenarios redactados en lenguaje Gherkin durante las fases previas fueron traducidos en pruebas automatizadas dentro del entorno, verificando la correspondencia exacta entre los requerimientos del negocio y el comportamiento real del sistema. Por último, manteniendo el estándar de documentación técnica bilingüe en inglés, los endpoints del backend quedaron expuestos y validados mediante la interfaz interactiva de Swagger / OpenAPI, facilitando el proceso de despliegue continuo de los artefactos de software hacia la infraestructura en la nube. <br><br>
  ...
  AutoService.
        ...
        <td>AV1: Se logró comunicar de manera clara, estructurada y efectiva el proceso de diseño y las funcionalidades del sistema, facilitando la comprensión del proyecto para distintos tipos de audiencia y evidenciando dominio de los conceptos de UX/UI.<br><br>TB1: Se logró comunicar de manera clara, estructurada y efectiva el avance del proceso de implementación del sistema durante el Sprint 2, explicando las funcionalidades desarrolladas en la Web Application en Angular y TypeScript, así como la integración con la Fake REST API. Esto permitió que distintos tipos de audiencia, tanto técnica como no técnica, comprendieran el funcionamiento del sistema, las decisiones de arquitectura frontend y el flujo de consumo de servicios HTTP.<br><br>AV2: El equipo consolidó una comunicación oral fluida y estructurada al sustentar las demostraciones de integración del sistema y justificar las decisiones técnicas del backend en Spring Boot ante perfiles con distintos niveles de conocimiento técnico, demostrando claridad y dominio conceptual en las revisiones del sprint.</td>
      </tr>
      <tr>
        <td>Comunica por escrito con efectividad a diferentes rangos de audiencia.</td>
        <td>
          <b>Aguilar Aguayo, Jeferson Renzo</b> AV1: Se elaboró la documentación técnica y contribuí en la implementación de la gestión del código mediante GitFlow, organizando las ramas y estándares de programación en inglés para facilitar el desarrollo colaborativo y mantener coherencia con la arquitectura y el despliegue profesional de AutoService<br><br>TB1: Durante el hito del TB1, se priorizó el establecimiento de bases sólidas para el control de versiones y la documentación técnica del ecosistema AutoService. En primer lugar, se elaboraron mensajes de confirmación de código siguiendo estrictamente la convención de Conventional Commits (utilizando prefijos como feat:, fix:, docs:, entre otros), lo que permitió describir de manera clara, semántica y estructurada cada cambio e incremento realizado en el sistema.

Asimismo, se contribuyó activamente a la documentación técnica del proyecto mediante la actualización y estructuración de secciones clave en el repositorio de la organización. Esto incluyó la redacción de las guías de configuración del entorno de desarrollo, las estrategias de integración con la Fake API para simular el comportamiento del backend en las fases tempranas.<br><br>AV2: Para el avance del AV2, el enfoque se centró en la maduración de la arquitectura de servicios y la preparación del sistema para entornos de producción estables. En ese sentido, elaboré la documentación técnica detallada de los servicios web del backend utilizando la especificación OpenAPI (Swagger). En este proceso, se detalló minuciosamente la sintaxis de las peticiones HTTP (GET, POST, PUT, DELETE), los parámetros requeridos en las cabeceras y rutas, y las estructuras exactas de las respuestas en formato JSON para cada endpoint del sistema, garantizando un contrato de API claro para el consumo desde el frontend en Angular.<br><br>
